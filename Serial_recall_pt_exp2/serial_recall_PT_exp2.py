...
#Serial Recall Probe Task Experiment 2; Changing-state = changing intensities of the vibrations
...
expName = u'Serial Recall - Probe Task - Experiment 2'  #
...
datafile = u'Data' + os.path.sep + u'Data_Serial_Recall_PT_exp2.csv'
...
for block in range(3):
    ...
    if order[block] == 0:
        ...
        if int(expInfo['Participant']) in range(1,15) or int(expInfo['Participant']) in range(29,36): 
            vib = [5,15]#1 equals speed 1 to the "black" handle and 4 speed 1 to the "yellow" handle
